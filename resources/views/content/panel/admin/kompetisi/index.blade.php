...
<div class="mb-4 d-flex justify-content-between align-items-center">
    ...
    <button class="btn btn-primary shadow-sm" style="background-color: var(--primary-color); border-color: var(--primary-color);">
        ...
        <table class="table mb-0 w-100 my-table">
            ...
            <tbody>
                <tr>
                    <td>1</td>`
                    <td>
                        <img src="{{ asset('images/kompetisi-1.jpg') }}" alt="" width="100px">
                    </td>
                    <td>Information Technology Creative Competition</td>
